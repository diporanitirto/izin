    ...
    <div className="fixed inset-0 bg-scoutBrown-900/90 backdrop-blur-sm flex items-center justify-center z-[100] p-4 animate-fade-in">
      <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-8 animate-scale-in">
        <div className="text-center mb-6">
          <div className="mx-auto flex items-center justify-center h-16 w-16 rounded-xl bg-gradient-to-br from-scoutBrown-700 to-scoutBrown-900 mb-4 shadow-lg">
        ...
        <div className="mt-6 pt-4 border-t border-scoutBrown-200">
